package com.has.phonechargeservice.mqseivice;

import com.alibaba.fastjson.JSONObject;
import com.has.phonechargeservice.config.Jms;
...
public class OrderConsumer {
    ...
    public OrderConsumer(@Autowired Jms jms, @Autowired ChargeService chargeService) throws MQClientException {
        //设置消费组
        ...
        consumer.registerMessageListener((MessageListenerConcurrently) (msgs, context) -> {
            ...
            try {
                chargeService.updateStore(productId, total, key, tradeNo);
                return ConsumeConcurrentlyStatus.CONSUME_SUCCESS;
            } catch (Exception e) {
